...
class PETRHeadPTH(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        if class_weight is not None and (self.__class__ is PETRHeadPTH):
        ...
        super(PETRHeadPTH, self).__init__(num_classes, in_channels, init_cfg = init_cfg)
    ...
    def position_embeding(self, img_feats, img_metas, masks=None):
        ...
        # e_time = time.time()
        # print("    Position_embeding: lidar2img process {}ms".format((e_time - s_time)*1000))
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if (version is None or version < 2) and self.__class__ is PETRHeadPTH:
            convert_dict = {
    ...
    def forward(self, mlvl_feats, img_metas):
        ...
        print("*"*50)
        # print("lidar2img:", img_metas[0]['lidar2img'])

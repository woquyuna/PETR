...
# data_root = '/mnt/data/dataset/nuscenes_mini/'
data_root = '/mnt/apollo/dataset/nuScenes/v1.0-trainval/'
...
train_pipeline = [
    dict(type='LoadMultiViewImageFromFiles7v', to_float32=True,color_type='unchanged', pseudo_tele_r=0.5),
    dict(type='LoadAnnotations3D', with_bbox_3d=True, with_label_3d=True, with_attr_label=False),
    dict(type='ObjectRangeFilter', point_cloud_range=point_cloud_range),
    dict(type='ObjectNameFilter', classes=class_names),
    dict(type='ResizeCropFlipImage7v', data_aug_conf = ida_aug_conf, training=False),
...
load_from=None
# load_from="ckpts/float_epoch_24.pth"
resume_from=None
